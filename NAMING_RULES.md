...
> อัปเดตล่าสุด: 9 เม.ย. 2569

> **กฎเหล็ก:** ห้ามฝังข้อมูลดิบ (hardcode) ลงใน index.html โดยตรง ไม่ว่าจะกรณีใด
> ข้อมูลทุกชนิดต้องมี API endpoint + build function — ฝังได้เฉพาะตอน Push Git แล้ว restore ทันที
